...
import { Calendar, FileText, Table, Printer, Plus, Trash2, Info, Link, RefreshCw, AlertCircle } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'summary' | 'sheet'>('summary');
    ...
    <div className="min-h-screen pb-12">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="min-h-[400px]">
          {activeTab === 'summary' ? (
            <OtSummary data={calculationResult} />
          ) : (
            <SignSheet 
